...
begin
  ...
  Jeweler::Tasks.new do |gem|
    gem.name = "oct"
    gem.summary = %Q{Command line octal file permissions}
    gem.description = %Q{Command line octal file permissions}
    ...
    gem.add_development_dependency "aruba", ">= 0.2.0"
